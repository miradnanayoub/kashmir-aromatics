      ...
      <section className="py-24 bg-[#1A1A1A] text-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {/* Value 1: Altitude */}
            <div className="bg-[#262626] p-10 rounded-[2rem] hover:bg-[#333] transition-colors duration-300 border border-white/5 group">
          ...
          <div className="mt-16 text-center">
            <Link 
               href="/about" 
               className="inline-flex items-center gap-2 text-brand-gold font-bold uppercase tracking-widest text-xs hover:text-white transition-colors"
            >
